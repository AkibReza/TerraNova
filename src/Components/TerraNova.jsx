...
const TerraNova = () => {
  ...
  const processGeminiOutput = (output) => {
    try {
      ...
      if (!jsonMatch) {
        // If not in a code block, try to find JSON object pattern
      ...
      const formattedData = {
        priceRange: parsedData.PriceRange || null,
        propertyType: parsedData.PropertyType || null,
        propertySize: parsedData.PropertySize || null,
        numberOfBedrooms: parsedData.NumberOfBedrooms || null,
        numberOfBathrooms: parsedData.NumberOfBathrooms || null,
