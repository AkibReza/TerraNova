...
const CompanyInfo = () => {
  ...
  const teamMembers = [
    {
      ...
      image: `${config.baseImagePath}/team/akib.jpg`,
      skills: [
        "MERN Stack",
  ...
  const specialties = [
    ...
    },
    {
      title: "Virtual Tours",
      description:
        "Cutting-edge virtual tour technology allowing clients to explore properties remotely",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
              ...
              >
                ...
                <p className="text-base text-gray-700 leading-relaxed mt-4">
                  Our platform leverages cutting-edge web technologies to
                  provide intuitive property searches, detailed listings, and
                  valuable market insights. We're committed to transparency,
                  quality service, and helping our users make informed decisions
