  ...
  const teamMembers = [
    {
      ...
      image: `${import.meta.env.VITE_BASE_URL}/images/team/akib.jpg`,
      skills: [
        "MERN Stack",
      ...
      aspiration:
        "To become a full-stack expert specializing in scalable web applications",
    },
    {
      id: 2,
      ...
      image: `${import.meta.env.VITE_BASE_URL}/images/team/asmaul.jpg`,
      skills: ["UI/UX Design", "JavaScript", "Frontend Development"],
      aspiration:
        "Creative Director for user experience design at a major tech company",
    },
    {
      id: 3,
      ...
      image: `${import.meta.env.VITE_BASE_URL}/images/team/mehtab.jpg`,
    ...
    },
    {
      ...
      image: `${import.meta.env.VITE_BASE_URL}/images/team/jawad.jpg`,
      skills: [
        "Working closely with developers, data analysts, and DevOps engineers",
      ],
      aspiration:
        "Optionally earn certifications and apply for roles like DB Engineer or DBA.",
    },
  ];
  ...
  const specialties = [
    {
      ...
      description:
        "Exclusive access to high-end residential and commercial properties in prime locations",
      icon: <Building className="h-10 w-10 text-blue-500" />,
    },
    {
      title: "Digital Marketing",
      description:
        "Innovative digital marketing strategies to maximize property visibility and engagement",
...

    {
      ...
      description:
        "Comprehensive market research and analysis to ensure optimal investment decisions",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
              ...
              >
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-blue-800 m-0">
                    Who We Are
                  </h3>
                </div>
                <p className="text-base text-gray-700 leading-relaxed">
                  TerraNova is a premier real estate platform developed by
                  students from the University of Information Technology and
                  Sciences. Founded with a vision to revolutionize property
                  searching, we combine technological innovation with real
                  estate expertise to create a seamless experience for buyers,
                  sellers, and agents.
                </p>
                ...
                <div className="mt-6 bg-gradient-to-r from-blue-600 to-blue-800 p-6 rounded-xl text-white">
                  <p className="text-lg font-medium italic m-0">
                    "Revolutionizing real estate through innovation and
                    technology."
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <p className="text-base text-gray-700 leading-relaxed">
                  Our diverse team consists of talented students specializing in
                ...
                <div className="mt-6 bg-blue-50 p-4 rounded-xl">
                  <p className="text-sm text-blue-800 m-0">
                    All team members are third-year Computer Science &
                    Engineering students at UITS
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <p className="text-base text-gray-700 leading-relaxed">
                  We're committed to revolutionizing the real estate industry
                  through:
                </p>
                <ul className="list-none p-0">
                  <li className="flex items-center space-x-2 mb-2">
        ...
        >
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center justify-center mb-12">
              ...
              <h2 className="text-4xl font-bold mx-6 text-blue-800">
                Our Team
              </h2>
              <div className="h-0.5 bg-blue-200 flex-grow"></div>
            </div>
            ...
            <p className="text-xl text-center text-gray-600 mb-12">
              Meet the talented students from University of Information
              Technology and Sciences behind TerraNova
            </p>
                      ...
                      <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="bg-indigo-50 p-4 rounded-lg">
                          <h4 className="text-lg font-semibold text-indigo-700 mb-3 flex items-center">
                            <Target size={16} className="mr-2" /> Future
                            Aspiration
                          </h4>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-blue-100 mb-8 max-w-2xl mx-auto">
                Reach out to our team for collaboration opportunities or to
                learn more about our real estate platform
              </p>
              <button
