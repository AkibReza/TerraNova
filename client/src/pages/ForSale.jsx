      ...
      setProperties([
        {
          ...
          bedrooms: 3,
          bathrooms: 3,
          description: "Elegant apartment with premium finishes and stunning city views in a prestigious location.",
          features: ["Security", "Parking", "Elevator", "Ready to Move", "Registered"]
        },
        {
          id: 2,
          ...
          bedrooms: 5,
          bathrooms: 4,
          description: "Beautiful family home with garden and modern amenities in a prime residential area.",
        ...
        },
        {
          ...
          bedrooms: 4,
          bathrooms: 4,
          description: "Exclusive penthouse with panoramic views, private terrace and premium fixtures.",
          features: ["24/7 Security", "Elevator", "Roof Access", "Parking", "Registered"]
        },
        {
          id: 4,
          ...
          bedrooms: 3,
          bathrooms: 2,
          description: "Contemporary apartment with excellent amenities in a developing neighborhood.",
        ...
        },
        {
          ...
          bedrooms: 4,
          bathrooms: 3,
          description: "Spacious family residence with modern features and excellent school accessibility.",
        ...
        },
        {
          ...
          bedrooms: 6,
          bathrooms: 5,
          description: "Prestigious villa with luxurious finishes, swimming pool and expansive living areas.",
          features: ["24/7 Security", "Garden", "Generator", "Parking", "Registered"]
        }
      ]);
      setLoading(false);
    }, 1000);
        ...
        <div className="container mx-auto px-4 pt-16 pb-32">
          ...
          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2">
            ...
            >
              ...
              <rect x="75" y="30" width="10" height="10" fill="white" opacity="0.7" />
              <rect x="95" y="30" width="10" height="10" fill="white" opacity="0.7" />
              <rect x="75" y="50" width="10" height="10" fill="white" opacity="0.7" />
              <rect x="95" y="50" width="10" height="10" fill="white" opacity="0.7" />
              <rect x="75" y="70" width="10" height="10" fill="white" opacity="0.7" />
              <rect x="95" y="70" width="10" height="10" fill="white" opacity="0.7" />
              
              {/* Building 2 */}
              <rect x="120" y="40" width="50" height="80" fill="#5D85D6" />
              <rect x="125" y="50" width="40" height="15" fill="#3B6FCB" />
              <rect x="130" y="75" width="10" height="10" fill="white" opacity="0.7" />
              <rect x="150" y="75" width="10" height="10" fill="white" opacity="0.7" />
              <rect x="130" y="95" width="10" height="10" fill="white" opacity="0.7" />
              <rect x="150" y="95" width="10" height="10" fill="white" opacity="0.7" />
              
              {/* Building 3 */}
              <rect x="180" y="50" width="35" height="70" fill="#7599E0" />
              <rect x="185" y="60" width="8" height="8" fill="white" opacity="0.7" />
              <rect x="202" y="60" width="8" height="8" fill="white" opacity="0.7" />
              <rect x="185" y="75" width="8" height="8" fill="white" opacity="0.7" />
              <rect x="202" y="75" width="8" height="8" fill="white" opacity="0.7" />
              
              {/* Building 4 */}
              <rect x="225" y="10" width="30" height="110" fill="#1C4CAA" />
              <rect x="230" y="20" width="5" height="5" fill="white" opacity="0.7" />
              <rect x="245" y="20" width="5" height="5" fill="white" opacity="0.7" />
              <rect x="230" y="35" width="5" height="5" fill="white" opacity="0.7" />
              <rect x="245" y="35" width="5" height="5" fill="white" opacity="0.7" />
              <rect x="230" y="50" width="5" height="5" fill="white" opacity="0.7" />
              <rect x="245" y="50" width="5" height="5" fill="white" opacity="0.7" />
              <rect x="230" y="65" width="5" height="5" fill="white" opacity="0.7" />
              <rect x="245" y="65" width="5" height="5" fill="white" opacity="0.7" />
              <rect x="230" y="80" width="5" height="5" fill="white" opacity="0.7" />
              <rect x="245" y="80" width="5" height="5" fill="white" opacity="0.7" />
              
              {/* Building 5 */}
              <rect x="265" y="40" width="55" height="80" fill="#6E90DF" />
              <rect x="275" y="50" width="10" height="10" fill="white" opacity="0.7" />
              <rect x="295" y="50" width="10" height="10" fill="white" opacity="0.7" />
              <rect x="285" y="70" width="15" height="15" fill="#3B6FCB" />
              <rect x="275" y="95" width="10" height="10" fill="white" opacity="0.7" />
              <rect x="295" y="95" width="10" height="10" fill="white" opacity="0.7" />
            </motion.svg>
          </div>
